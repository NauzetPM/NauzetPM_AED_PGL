...
public class Asignatura implements Serializable {
	...
	@JoinTable(
		...
		, joinColumns={
			@JoinColumn(name="idasignatura")//id de la tabla intermedia que es key en esta tabla
			}
		, inverseJoinColumns={
			@JoinColumn(name="idmatricula")//id de la tabla intermedia que es key en la otra tabla
			}
		)
